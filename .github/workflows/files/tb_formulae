    ...
    class Formulae < TestFormulae
      ...
      def setup_formulae_deps_instances(formula, formula_name, args:)
        ...
        unless changed_dependencies.empty?
          ...
          # this step
          test "brew", "postinstall", named_args: changed_dependencies
          #, ignore_failures:
        end
      ...
      def formula!(formula_name, args:)
        ...
        bottled_on_current_version = bottled?(formula, no_older_versions: false)
        ...
        ignore_failures = !args.test_default_formula? && !new_formula
